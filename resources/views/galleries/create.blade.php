    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="{{ route('galleries.index') }}" class="bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium py-2 px-4 rounded-md">
                    Back to Galleries
                </a>
            </div>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('galleries.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="event_id" id="event_id" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="mb-6">
                            ...
                            <p class="mt-1 text-sm text-gray-500">You can select multiple images. Max size per image: 5MB. Formats: jpg, jpeg, png.</p>
                            @error('images')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            @error('images.*')
